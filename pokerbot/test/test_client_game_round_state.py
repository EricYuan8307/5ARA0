...
class TestClientGameRoundState:
 ...
 # <ASSIGNMENT: Test the creation, reading and updating of ClientGameRoundState>
    def test_game_round_state_creation(self, gameroundstate):
        """ Create a gameroundstate object and test it.

        Args:
            gameroundstate (ClientGameRoundState): ClientGameRoundState object.
        """ 
    ...
    def test_reading_game_round_state(self, gameroundstate):    
        ...
        assert gameroundstate.get_round_id() == 1                                  # The first round_id should be 1
    ...
    def test_updating_game_round_state(self, gameroundstate):
        ...
        # update the outcome
        outcome = '-4'
        assert gameroundstate.get_outcome() == None # check if outcome at start of round is none
